    ...
    <section class="sub-content" style="padding: 5px 0 50px 0 !important;">
        ...
        <div class="row">
            <h2 class="col-md-10 offset-md-1 mt-4" align="right">
                Tổng <?php echo $active == 'totalPrice' ? 'tiền cước' : 'tiền thu hộ COD' ?> (VND): 
            ...
            <div class="col-md-10 offset-md-1">
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <th scope="col"><?php echo $active == 'totalPrice' ? 'Tiền cước' : 'Tiền thu hộ COD' ?> (VND)</th>
                        @if($active == 'totalPrice')
                    ...
                    @if(isset($bookings) && count($bookings) > 0)
                        @foreach($bookings as $b)
                            <tr>
                                ...
                                <td>{!! $b->created_at !!}</td>
                                <td class="text-success"><?php echo $active == 'totalPrice' ? number_format($b->price) : number_format($b->COD) ?></td>
                                @if($active == 'totalPrice')
