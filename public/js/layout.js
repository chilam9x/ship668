...
var Layout = function () {
    ...
    var handleSidebarMenu = function () {
        ...
        $('.page-sidebar-menu').on('click', 'li > a.nav-toggle, li > a > span.nav-toggle', function (e) {
            ...
            var href = that.next().find('.nav-item:first-child a').attr('href')
...
if (App.isAngularJsApp() === false) {
   ...
   jQuery(document).ready(function() {    
       Layout.initSidebar(); // init metronic core componets
       jQuery('div.alert').not('.alert-danger').delay(3000).fadeOut(350);
    });
}
console.log('jQuery(".switch-on-off")',jQuery(".switch-on-off"));
jQuery(".switch-on-off").bootstrapSwitch({
  onColor: 'success',
  onText: '',
  offText: '',
  handleWidth: 10
