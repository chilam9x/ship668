    ...
    <div class="col-lg-6">
        <div class="portlet light bordered">
            ...
            <div class="portlet-body form">
                <form method="post" action="{!! isset($reAssign) ? url('/admin/booking/reassign/'.$cate.'/'.$id) : url('/admin/booking/send_assign/'.$id) !!}">
                    {!! csrf_field() !!}
                    <div class="row">
                        <div class="col-lg-6">
                    ...
                    <a href="{{ url('/admin/booking/received') }}" type="button" class="btn default">Hủy</a>
                </form>
            </div>
        </div>
    </div>
